...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.SubscriptionInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).subscription.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.SubscriptionInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).subscription.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.SubscriptionInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).subscription.findFirst(input as any))),

        findMany: procedure.input($Schema.SubscriptionInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).subscription.findMany(input as any))),
        ...
        count: procedure.input($Schema.SubscriptionInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).subscription.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.SubscriptionCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.SubscriptionCountAggregateOutputType>
            : number>(
