...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.ApplicationInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).application.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.ApplicationInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).application.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.ApplicationInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).application.findFirst(input as any))),

        findMany: procedure.input($Schema.ApplicationInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).application.findMany(input as any))),
        ...
        count: procedure.input($Schema.ApplicationInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).application.count(input as any))),
